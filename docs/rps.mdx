...
sidebar_position: 4
title: Terrenos
description: Tutorial sobre proteção de Terrenos
---

import Video from "../src/components/Video.js";

O Servidor utiliza o plugin "[RedProtect](https://www.spigotmc.org/resources/redprotect-anti-grief-server-protection-region-management-1-7-1-16.15841/)" para proteção de terrenos, com um limite de até `2,000` terrenos. Você pode proteger até `1,000,000` blocos, e a proteção conta todo os blocos do céu a bedrock.
